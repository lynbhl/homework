...
def main():
    ...
    for order in [0, 3, 6, 9]:
        ...
        model.plot(save_path=f"D:\DSEB 62\ML1\W4\output image\Problem "
    ...
    model1.plot(save_path=f"D:\DSEB 62\ML1\W4\output image\Problem 2 "
                          f"part b small.png")
    model2.plot(save_path=f"D:\DSEB 62\ML1\W4\output image\Problem 2 "
                          f"part b large.png")
    ...
    model.plot(
        save_path=f"D:\DSEB 62\W4\output image\Problem 2 Ridge Regression.png")
    ...
    model.plot(save_path=f"D:\DSEB 62\ML1\W4\output image\Problem 2 Lasso Regression.png")
